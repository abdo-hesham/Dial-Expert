...
## Corpus Check
- 36 files · ~2,319,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 228 nodes · 288 edges · 17 communities (11 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e50c7bee`
...
Cohesion: 0.06
Nodes (17): ByTheNumbers, ContactForm, FAQs, FinalCTA, FooterSection, HowWeOperate, MeetTheTeam, TheChallenge (+9 more)
