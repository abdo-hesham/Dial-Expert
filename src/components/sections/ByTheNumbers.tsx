...
const stats = [
  { value: "7+", label: "Years Operating", sub: "Operating in the industry." },
  { value: "250+", label: "Active Professionals", sub: "Active, on-floor professionals." },
  { value: "20+", label: "Dedicated Managers", sub: "Dedicated managers." },
  { value: "$300M+", label: "Revenue Generated", sub: "Revenue generated across client campaigns." },
]
